  ...
  fr: {
    ...
    product: {
      ...
      pillars: {
        ...
        priceText: "Le meilleur rapport qualité/prix du marché",
        eu: "Fabriqué en UE",
        euText: "Usines certifiées GMP & ISO 22000",
      },
      loading: "Chargement des produits...",
      empty: "Aucun produit disponible pour le moment.",
      categories: {
        daily_multivitamins: "Multivitamines quotidiennes",
        immunity: "Immunité",
        bone_health: "Santé osseuse",
        magnesium_muscle: "Magnésium & Santé musculaire",
        heart_health: "Santé cardiaque",
        brain_memory: "Cerveau & Mémoire",
        sleep: "Sommeil",
        stress_management: "Gestion du stress",
        mens_health: "Santé masculine",
        womens_health: "Santé féminine",
        hair_skin_nails: "Cheveux, peau & ongles",
        beauty_collagen: "Beauté & Collagène",
        digestive_health: "Santé digestive",
        joint_health: "Santé articulaire",
        eye_health: "Santé oculaire",
        liver_antioxidant: "Foie & Antioxydants",
        childrens_health: "Santé des enfants",
        hydration_electrolytes: "Hydratation & Électrolytes",
      },
      statuses: {
  ...
  ar: {
    ...
    product: {
      ...
      pillars: {
        ...
        price: "أسعار تنافسية",
        priceText: "أفضل قيمة في السوق",
        eu: "صنع في الاتحاد الأوروبي",
        euText: "مصانع معتمدة GMP و ISO 22000",
      },
      loading: "جارٍ تحميل المنتجات...",
      empty: "لا توجد منتجات متاحة حاليًا.",
      categories: {
        daily_multivitamins: "متعدد الفيتامينات اليومي",
        immunity: "المناعة",
        bone_health: "صحة العظام",
        magnesium_muscle: "المغنيسيوم وصحة العضلات",
        heart_health: "صحة القلب",
        brain_memory: "الدماغ والذاكرة",
        sleep: "النوم",
        stress_management: "إدارة التوتر",
        mens_health: "صحة الرجل",
        womens_health: "صحة المرأة",
        hair_skin_nails: "الشعر والبشرة والأظافر",
        beauty_collagen: "الجمال والكولاجين",
        digestive_health: "صحة الجهاز الهضمي",
        joint_health: "صحة المفاصل",
        eye_health: "صحة العين",
        liver_antioxidant: "الكبد ومضادات الأكسدة",
        childrens_health: "صحة الأطفال",
        hydration_electrolytes: "الترطيب والإلكتروليتات",
      },
      statuses: {
  ...
  en: {
    ...
    product: {
      ...
      pillars: {
        ...
        priceText: "Best value on the market",
        eu: "Made in the EU",
        euText: "GMP & ISO 22000 certified facilities",
      },
      loading: "Loading products...",
      empty: "No products available yet.",
      categories: {
        daily_multivitamins: "Daily Multivitamins",
        immunity: "Immunity",
        bone_health: "Bone Health",
        magnesium_muscle: "Magnesium & Muscle Health",
        ...
        beauty_collagen: "Beauty & Collagen",
        digestive_health: "Digestive Health",
        joint_health: "Joint Health",
        eye_health: "Eye Health",
        liver_antioxidant: "Liver Health & Antioxidant",
